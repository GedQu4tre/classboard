<template>
    <footer class="text-gray-500 px-4 py-5 max-w-screen-xl mx-auto ring-1 ring-indigo-200 rounded-xl mb-5 p-6 shadow-md">
      <div class="max-w-lg sm:mx-auto sm:text-center">
        <h4 class="text-2xl flex justify-center font-bold text-indigo-950"><GlobeAltIcon class="size-6 my-auto text-indigo-800" /> &nbsp;Classboard</h4>
        <p class="leading-relaxed mt-2 text-[15px]">
          Classboard est un produit de GedIndustries mis à disposition des insitutions scolaires pour leur permettre une bonne et facile gestion de leurs établissements. Avec GedIndustries, You'll Never Walk Alone
        </p>
      </div>
